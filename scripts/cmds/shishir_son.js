...
module.exports.onStart = async function ({ api, event, args }) {
  ...
  if (!admins.includes(event.senderID)) {
    return api.sendMessage(
      "❌ Only my boss SHISHIR  can use this command!",
      event.threadID,
      event.messageID
    );
  }
...
module.exports.onChat = async function ({ api, event }) {
  ...
  const messages = [
    ...
    "\nশিশির বস তোর মাকে গাধার মতো চুদে বলবো এটা কার মাল? 😂",  
    "\nএই খানকির পোলা বেশ্যার পোলা তোর মাকে চুদে আমার বস momin সারা বেলা,🖕💯",  
    "\nবস ফারহান বস তোর মার গুদে ইনপুট দিয়ে আউটপুট নেবো! 💀",  
    "\nআম পাতা জোড়া জোড়া তোর মাকে চূদে আমার বস শিশির উরাধুরা..!🖕💯",
    "\nতুই নাকি অনলাইনের কিং তোর মায়ের ভোদা মধ্যে বাজামু সাপের বিন বিনের তালে তালে চুদতে চুদতে নিয়া যামু খালে খালে নাই সাপ আমার বস শিশির তোর অবৈধ বাপ💦👅..",
    ...
    "\nএই মুরগি খাংকির পোলা শিশির বস তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস..!!",
    "\nখাংকির পোলা তুই শিশির বস কে গালি দেস তুই তো রাস্তার পতিতার পুত ছোডো ভাই তর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈?",
